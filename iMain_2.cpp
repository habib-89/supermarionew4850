...
char tile_array[100][100] = {"_________ *_____*_____*____*"};
...
void load_bg()
{
    iLoadImage(&bg, "C:/Users/user/OneDrive/Desktop/Game Project/assets/Level1image/BGL1001.png");
    iResizeImage(&bg, 900, 450);
}

void loadResources()
{
    iLoadFramesFromFolder(golem_idle, "C:/Users/user/OneDrive/Desktop/Game Project Pic/walk");
    iLoadFramesFromFolder(golem_run_frames, "C:/Users/user/OneDrive/Desktop/Game Project Pic/run");
    iLoadFramesFromFolder(golem_jump_frames, "C:/Users/user/OneDrive/Desktop/Game Project Pic/jump");
    iInitSprite(&golem, -1);
    ...
    iLoadFramesFromFolder(tile_set, "C:/Users/user/OneDrive/Desktop/Game Project Pic/tiile");
    for (int i = 0; i < 28; i++)
    {
        if (tile_array[0][i] == '_')
            tile_x += 20;
